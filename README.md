...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,704 | 🐛 106 | 📅 2026-09-02
...
* [Open Container Specifications](https://github.com/opencontainers/specs) ⭐ 3,680 | 🐛 95 | 🌐 Go | 📅 2026-04-24\
...
* [Photon](https://github.com/vmware/photon) ⭐ 3,178 | 🐛 248 | 🌐 C | 📅 2026-09-21\
...
* [Docker](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure) ⭐ 36,864 | 🐛 37 | 📅 2026-09-12\
  An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD](https://github.com/lxc/lxd) ⭐ 6,223 | 🐛 45 | 🌐 Go | 📅 2026-09-21\
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,863 | 🐛 99 | 🌐 Rust | 📅 2026-09-21\
  Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [podman](https://github.com/containers/libpod) ⭐ 32,910 | 🐛 1,021 | 🌐 Go | 📅 2026-09-21\
  Full management of container lifecycle.
* [runc](https://github.com/opencontainers/runc) ⭐ 13,454 | 🐛 336 | 🌐 Go | 📅 2026-09-22\
...
* [youki](https://github.com/containers/youki) ⭐ 7,609 | 🐛 137 | 🌐 Rust | 📅 2026-09-22\
  A container runtime written in Rust.
* [LXC](https://github.com/lxc/lxc) ⭐ 5,263 | 🐛 151 | 🌐 C | 📅 2026-09-07\
  LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [sysbox](https://github.com/nestybox/sysbox) ⭐ 3,880 | 🐛 213 | 🌐 Shell | 📅 2026-09-15\
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,788 | 🐛 40 | 🌐 Python | 📅 2025-08-13\
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) ⭐ 8,788 | 🐛 196 | 🌐 C | 📅 2026-09-21\
...
* [NsJail](https://github.com/google/nsjail) ⭐ 4,116 | 🐛 41 | 🌐 C++ | 📅 2026-08-27\
...
* [singularity](https://github.com/singularityware/singularity) ⭐ 2,623 | 🐛 0 | 🌐 Go | 📅 2022-10-10\
...
* [Moby](https://github.com/moby/moby) ⭐ 72,120 | 🐛 3,905 | 🌐 Go | 📅 2026-09-21\
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,591 | 🐛 213 | 🌐 Go | 📅 2025-12-15\
  A tool for exploring each layer in a docker image.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived\
  Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [skopeo](https://github.com/projectatomic/skopeo) ⭐ 11,244 | 🐛 81 | 🌐 Go | 📅 2026-09-21\
  Work with remote images registries - retrieving information, images, signing content.
* [buildah](https://github.com/projectatomic/buildah) ⭐ 9,028 | 🐛 281 | 🌐 Go | 📅 2026-09-21\
  A tool which facilitates building OCI container images.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,055 | 🐛 155 | 🌐 Go | 📅 2026-09-16\
  Go library and CLIs for working with container registries.
* [img](https://github.com/jessfraz/img) ⭐ 3,987 | 🐛 110 | 🌐 Go | 📅 2024-05-19\
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,531 | 🐛 757 | 🌐 TypeScript | 📅 2026-09-21\
...
* [gvisor](https://github.com/google/gvisor) ⭐ 19,384 | 🐛 804 | 🌐 Go | 📅 2026-09-22\
  gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [Docker bench security](https://github.com/docker/docker-bench-security) ⭐ 9,699 | 🐛 28 | 🌐 Shell | 📅 2026-06-04\
  The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [goss](https://github.com/aelsabbahy/goss) ⭐ 5,973 | 🐛 57 | 🌐 Go | 📅 2026-09-14\
