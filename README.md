...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,270 | 🐛 105 | 📅 2026-08-18
...
* [Open Container Specifications](https://github.com/opencontainers/specs) ⭐ 3,667 | 🐛 94 | 🌐 Go | 📅 2026-04-24\
...
* [Photon](https://github.com/vmware/photon) ⭐ 3,179 | 🐛 249 | 🌐 Python | 📅 2026-08-20\
...
* [Docker](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure) ⭐ 36,674 | 🐛 14 | 📅 2026-08-19\
  An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD](https://github.com/lxc/lxd) ⭐ 5,994 | 🐛 37 | 🌐 Go | 📅 2026-08-21\
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,174 | 🐛 109 | 🌐 Rust | 📅 2026-08-20\
  Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [podman](https://github.com/containers/libpod) ⭐ 32,647 | 🐛 1,125 | 🌐 Go | 📅 2026-08-20\
...
* [Bocker](https://github.com/p8952/bocker) ⭐ 12,664 | 🐛 15 | 🌐 Shell | 📅 2017-12-09\
...
* [youki](https://github.com/containers/youki) ⭐ 7,558 | 🐛 144 | 🌐 Rust | 📅 2026-08-21\
  A container runtime written in Rust.
* [LXC](https://github.com/lxc/lxc) ⭐ 5,243 | 🐛 150 | 🌐 C | 📅 2026-08-20\
  LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [sysbox](https://github.com/nestybox/sysbox) ⭐ 3,833 | 🐛 209 | 🌐 Shell | 📅 2026-08-15\
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,779 | 🐛 40 | 🌐 Python | 📅 2025-08-13\
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) ⭐ 8,435 | 🐛 191 | 🌐 C | 📅 2026-06-02\
...
* [NsJail](https://github.com/google/nsjail) ⭐ 4,062 | 🐛 66 | 🌐 C++ | 📅 2026-07-27\
...
* [singularity](https://github.com/singularityware/singularity) ⭐ 2,619 | 🐛 0 | 🌐 Go | 📅 2022-10-10\
...
* [Moby](https://github.com/moby/moby) ⭐ 71,986 | 🐛 3,897 | 🌐 Go | 📅 2026-08-20\
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,481 | 🐛 211 | 🌐 Go | 📅 2025-12-15\
  A tool for exploring each layer in a docker image.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived\
  Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [skopeo](https://github.com/projectatomic/skopeo) ⭐ 11,179 | 🐛 87 | 🌐 Go | 📅 2026-08-20\
  Work with remote images registries - retrieving information, images, signing content.
* [buildah](https://github.com/projectatomic/buildah) ⭐ 8,991 | 🐛 282 | 🌐 Go | 📅 2026-08-20\
  A tool which facilitates building OCI container images.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,017 | 🐛 166 | 🌐 Go | 📅 2026-08-20\
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,294 | 🐛 746 | 🌐 TypeScript | 📅 2026-08-20\
...
* [gvisor](https://github.com/google/gvisor) ⭐ 19,132 | 🐛 783 | 🌐 Go | 📅 2026-08-21\
  gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [Docker bench security](https://github.com/docker/docker-bench-security) ⭐ 9,694 | 🐛 29 | 🌐 Shell | 📅 2026-06-04\
  The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [goss](https://github.com/aelsabbahy/goss) ⭐ 5,949 | 🐛 68 | 🌐 Go | 📅 2026-08-19\
...
* [oci-seccomp-bpf-hook](https://github.com/containers/oci-seccomp-bpf-hook) ⭐ 348 | 🐛 5 | 🌐 Go | 📅 2026-08-20\
