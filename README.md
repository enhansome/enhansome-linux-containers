...
* [Photon](https://github.com/vmware/photon) ⭐ 3,181 | 🐛 245 | 🌐 Python | 📅 2026-08-15\
...
* [Docker](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure) ⭐ 36,647 | 🐛 25 | 📅 2026-07-29\
  An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD](https://github.com/lxc/lxd) ⭐ 5,951 | 🐛 43 | 🌐 Go | 📅 2026-08-16\
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,085 | 🐛 101 | 🌐 Rust | 📅 2026-08-14\
  Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [podman](https://github.com/containers/libpod) ⭐ 32,584 | 🐛 1,127 | 🌐 Go | 📅 2026-08-16\
...
* [youki](https://github.com/containers/youki) ⭐ 7,542 | 🐛 143 | 🌐 Rust | 📅 2026-08-15\
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) ⭐ 8,380 | 🐛 190 | 🌐 C | 📅 2026-06-02\
...
* [NsJail](https://github.com/google/nsjail) ⭐ 4,054 | 🐛 62 | 🌐 C++ | 📅 2026-07-27\
...
* [Moby](https://github.com/moby/moby) ⭐ 71,989 | 🐛 3,881 | 🌐 Go | 📅 2026-08-15\
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,454 | 🐛 209 | 🌐 Go | 📅 2025-12-15\
  A tool for exploring each layer in a docker image.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived\
  Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [skopeo](https://github.com/projectatomic/skopeo) ⭐ 11,165 | 🐛 88 | 🌐 Go | 📅 2026-08-14\
  Work with remote images registries - retrieving information, images, signing content.
* [buildah](https://github.com/projectatomic/buildah) ⭐ 8,983 | 🐛 282 | 🌐 Go | 📅 2026-08-16\
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,252 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-15\
...
* [gvisor](https://github.com/google/gvisor) ⭐ 19,090 | 🐛 778 | 🌐 Go | 📅 2026-08-15\
  gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [Docker bench security](https://github.com/docker/docker-bench-security) ⭐ 9,687 | 🐛 29 | 🌐 Shell | 📅 2026-06-04\
  The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [goss](https://github.com/aelsabbahy/goss) ⭐ 5,949 | 🐛 67 | 🌐 Go | 📅 2026-08-15\
