# Awesome Linux Containers with stars
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,596 | 🐛 100 | 📅 2026-06-30
...
* [App Container basics](https://github.com/coreos/rkt/blob/master/Documentation/app-container.md) ⚠️ Archived\
...
* [Open Container Specifications](https://github.com/opencontainers/specs) ⭐ 3,664 | 🐛 94 | 🌐 Go | 📅 2026-04-24\
  This project is where the Open Container Initiative Specifications are written. This is a work in progress.
* [Cloud Native Application Bundle Specification](https://github.com/deislabs/cnab-spec) ⭐ 972 | 🐛 31 | 🌐 Shell | 📅 2022-09-09\
...
* [Nulecule Specification](https://github.com/projectatomic/atomicapp/tree/master/docs/spec) ⚠️ Archived\
...
* [Warden](https://github.com/cloudfoundry/warden) ⚠️ Archived\
...
* [Photon](https://github.com/vmware/photon) ⭐ 3,181 | 🐛 245 | 🌐 Python | 📅 2026-08-16\
...
* [Docker](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure) ⭐ 36,646 | 🐛 25 | 📅 2026-07-29\
  An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD](https://github.com/lxc/lxd) ⭐ 5,962 | 🐛 44 | 🌐 Go | 📅 2026-08-16\
...
* [MultiDocker](https://github.com/marty90/multidocker) ⭐ 55 | 🐛 0 | 🌐 Dockerfile | 📅 2018-11-27\
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,099 | 🐛 102 | 🌐 Rust | 📅 2026-08-14\
  Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [podman](https://github.com/containers/libpod) ⭐ 32,594 | 🐛 1,130 | 🌐 Go | 📅 2026-08-16\
  Full management of container lifecycle.
* [runc](https://github.com/opencontainers/runc) ⭐ 13,402 | 🐛 342 | 🌐 Go | 📅 2026-08-16\
  runc is a CLI tool for spawning and running containers according to the OCS specification.
* [Bocker](https://github.com/p8952/bocker) ⭐ 12,663 | 🐛 15 | 🌐 Shell | 📅 2017-12-09\
...
* [youki](https://github.com/containers/youki) ⭐ 7,544 | 🐛 144 | 🌐 Rust | 📅 2026-08-17\
  A container runtime written in Rust.
* [LXC](https://github.com/lxc/lxc) ⭐ 5,240 | 🐛 148 | 🌐 C | 📅 2026-07-23\
  LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [sysbox](https://github.com/nestybox/sysbox) ⭐ 3,825 | 🐛 209 | 🌐 Shell | 📅 2026-08-15\
...
* [Vagga](https://github.com/tailhook/vagga) ⭐ 1,891 | 🐛 78 | 🌐 Rust | 📅 2023-03-31\
  Vagga is a fully-userspace container engine inspired by Vagrant and Docker, specialized for development environments.
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,776 | 🐛 40 | 🌐 Python | 📅 2025-08-13\
...
* [railcar](https://github.com/oracle/railcar) ⚠️ Archived\
...
* [runv](https://github.com/hyperhq/runv) ⚠️ Archived\
  Hypervisor-based (KVM, Xen, QEMU) Runtime for OCI. Security by isolation.
* [cc-oci-runtime](https://github.com/01org/cc-oci-runtime) ⚠️ Archived\
  Intel Clear Linux OCI (Open Containers Initiative) compatible runtime.
* [porto](https://github.com/yandex/porto) ⚠️ Archived\
...
* [plash](https://github.com/ihucos/plash/) ⭐ 382 | 🐛 9 | 🌐 C | 📅 2025-03-20\
  Lightweight, rootless containers.
* [libct](https://github.com/xemul/libct) ⭐ 108 | 🐛 8 | 🌐 C | 📅 2017-10-06\
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) ⭐ 8,387 | 🐛 190 | 🌐 C | 📅 2026-06-02\
...
* [NsJail](https://github.com/google/nsjail) ⭐ 4,055 | 🐛 62 | 🌐 C++ | 📅 2026-07-27\
...
* [singularity](https://github.com/singularityware/singularity) ⭐ 2,618 | 🐛 0 | 🌐 Go | 📅 2022-10-10\
  Universal application containers for Linux.
* [Subuser](https://github.com/subuser-security/subuser) ⭐ 895 | 🐛 43 | 🌐 Python | 📅 2025-02-23\
  Securing the Linux desktop with Docker.
* [Lxroot](https://github.com/parke/lxroot) ⭐ 121 | 🐛 2 | 🌐 C++ | 📅 2025-04-25\
...
* [Moby](https://github.com/moby/moby) ⭐ 71,981 | 🐛 3,887 | 🌐 Go | 📅 2026-08-16\
...
* [pyspaces](https://github.com/Friz-zy/pyspaces) ⚠️ Archived\
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,463 | 🐛 209 | 🌐 Go | 📅 2025-12-15\
  A tool for exploring each layer in a docker image.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived\
  Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [skopeo](https://github.com/projectatomic/skopeo) ⭐ 11,165 | 🐛 89 | 🌐 Go | 📅 2026-08-16\
  Work with remote images registries - retrieving information, images, signing content.
* [buildah](https://github.com/projectatomic/buildah) ⭐ 8,984 | 🐛 282 | 🌐 Go | 📅 2026-08-16\
  A tool which facilitates building OCI container images.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,012 | 🐛 173 | 🌐 Go | 📅 2026-08-12\
  Go library and CLIs for working with container registries.
* [img](https://github.com/jessfraz/img) ⭐ 3,989 | 🐛 110 | 🌐 Go | 📅 2024-05-19\
  Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder.
* [container-diff](https://github.com/GoogleCloudPlatform/container-diff) ⚠️ Archived\
  A tool for analyzing and comparing container images.
* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,191 | 🐛 8 | 🌐 Go | 📅 2026-04-08\
  Whaler is designed to reverse engineer a Docker Image into the Dockerfile that created it.
* [dgr](https://github.com/blablacar/dgr) ⚠️ Archived\
...
* [docker pushrm](https://github.com/christian-korneck/docker-pushrm) ⭐ 152 | 🐛 6 | 🌐 Go | 📅 2024-06-10\
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,256 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-15\
  Lightweight Docker management UI.
* [swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,484 | 🐛 180 | 🌐 Clojure | 📅 2026-07-01\
...
* [gvisor](https://github.com/google/gvisor) ⭐ 19,095 | 🐛 782 | 🌐 Go | 📅 2026-08-15\
  gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [Docker bench security](https://github.com/docker/docker-bench-security) ⭐ 9,689 | 🐛 29 | 🌐 Shell | 📅 2026-06-04\
  The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [goss](https://github.com/aelsabbahy/goss) ⭐ 5,949 | 🐛 68 | 🌐 Go | 📅 2026-08-16\
  Quick and Easy server testing/validation.
* [bane](https://github.com/jfrazelle/bane) ⭐ 1,230 | 🐛 4 | 🌐 Go | 📅 2020-09-17\
  Custom AppArmor profile generator for docker containers.
* [docker-explorer](https://github.com/google/docker-explorer/) ⚠️ Archived\
  A tool to help forensicate offline docker acquisitions.
* [oci-seccomp-bpf-hook](https://github.com/containers/oci-seccomp-bpf-hook) ⭐ 348 | 🐛 5 | 🌐 Go | 📅 2026-08-16\
  OCI hook to trace syscalls and generate a seccomp profile.
* [OpenSCAP](https://github.com/OpenSCAP/container-compliance) ⚠️ Archived\
...
* [sockguard](https://github.com/buildkite/sockguard) ⚠️ Archived\
  A proxy for docker.sock that enforces access control and isolated privileges.
* [drydock](https://github.com/zuBux/drydock) ⭐ 66 | 🐛 2 | 🌐 Python | 📅 2016-05-13\
...
* [sysdig-container-ecosystem](https://github.com/draios/sysdig-container-ecosystem) ⚠️ Archived\
