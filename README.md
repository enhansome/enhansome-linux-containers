...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,336 | 🐛 105 | 📅 2026-08-21
...
* [Docker](https://github.com/veggiemonk/awesome-docker#cloud-infrastructure) ⭐ 36,722 | 🐛 19 | 📅 2026-08-19\
  An open platform for distributed applications for developers and sysadmins. **Standard de facto**.
* [LXD](https://github.com/lxc/lxd) ⭐ 6,027 | 🐛 32 | 🌐 Go | 📅 2026-08-27\
...
* [firecracker](https://github.com/firecracker-microvm/firecracker) ⭐ 36,309 | 🐛 104 | 🌐 Rust | 📅 2026-08-26\
  Firecracker runs workloads in lightweight virtual machines, called microVMs, which combine the security and isolation properties provided by hardware virtualization technology with the speed and flexibility of containers.
* [podman](https://github.com/containers/libpod) ⭐ 32,704 | 🐛 1,139 | 🌐 Go | 📅 2026-08-26\
  Full management of container lifecycle.
* [runc](https://github.com/opencontainers/runc) ⭐ 13,416 | 🐛 349 | 🌐 Go | 📅 2026-08-24\
...
* [youki](https://github.com/containers/youki) ⭐ 7,566 | 🐛 152 | 🌐 Rust | 📅 2026-08-26\
  A container runtime written in Rust.
* [LXC](https://github.com/lxc/lxc) ⭐ 5,248 | 🐛 151 | 🌐 C | 📅 2026-08-20\
  LXC is the well known set of tools, templates, library and language bindings. It's pretty low level, very flexible and covers just about every containment feature supported by the upstream kernel.
* [sysbox](https://github.com/nestybox/sysbox) ⭐ 3,840 | 🐛 212 | 🌐 Shell | 📅 2026-08-25\
...
* [Bubblewrap](https://github.com/projectatomic/bubblewrap) ⭐ 8,498 | 🐛 191 | 🌐 C | 📅 2026-08-26\
...
* [NsJail](https://github.com/google/nsjail) ⭐ 4,074 | 🐛 8 | 🌐 C++ | 📅 2026-08-26\
...
* [Moby](https://github.com/moby/moby) ⭐ 72,003 | 🐛 3,905 | 🌐 Go | 📅 2026-08-27\
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,506 | 🐛 212 | 🌐 Go | 📅 2025-12-15\
  A tool for exploring each layer in a docker image.
* [kaniko](https://github.com/GoogleContainerTools/kaniko) ⚠️ Archived\
  Kaniko is a tool to build container images from a Dockerfile, inside a container or Kubernetes cluster.
* [skopeo](https://github.com/projectatomic/skopeo) ⭐ 11,194 | 🐛 89 | 🌐 Go | 📅 2026-08-26\
  Work with remote images registries - retrieving information, images, signing content.
* [buildah](https://github.com/projectatomic/buildah) ⭐ 8,995 | 🐛 287 | 🌐 Go | 📅 2026-08-26\
  A tool which facilitates building OCI container images.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,027 | 🐛 173 | 🌐 Go | 📅 2026-08-26\
...
* [portainer](https://github.com/portainer/portainer) ⭐ 38,356 | 🐛 744 | 🌐 TypeScript | 📅 2026-08-27\
...
* [gvisor](https://github.com/google/gvisor) ⭐ 19,166 | 🐛 828 | 🌐 Go | 📅 2026-08-27\
  gVisor is a user-space kernel, written in Go, that implements a substantial portion of the Linux system surface. It includes an Open Container Initiative (OCI) runtime called runsc that provides an isolation boundary between the application and the host kernel. The runsc runtime integrates with Docker and Kubernetes, making it simple to run sandboxed containers.
* [Docker bench security](https://github.com/docker/docker-bench-security) ⭐ 9,693 | 🐛 29 | 🌐 Shell | 📅 2026-06-04\
  The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker containers in production.
* [goss](https://github.com/aelsabbahy/goss) ⭐ 5,953 | 🐛 66 | 🌐 Go | 📅 2026-08-25\
...
* [oci-seccomp-bpf-hook](https://github.com/containers/oci-seccomp-bpf-hook) ⭐ 349 | 🐛 3 | 🌐 Go | 📅 2026-08-26\
